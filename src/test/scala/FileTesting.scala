...
//    val expectedResult = Left(model.Error("file not found"))
...
//    val expectedResult = Left(model.Error("Empty File"))
//    assertResult(expectedResult)(actualResult)
//  }
//
//  "Missing data in call logs" should "return a parse call error" in {
//    val actualResult = dataProcess("missing-data.log")
//    val expectedResult = (Left(model.Error("model.Error in ParseCall")))
//    assertResult(expectedResult)(actualResult)
//  }
//}